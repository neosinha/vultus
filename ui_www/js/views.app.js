...
function appNavBar() {
	...
	navbar = ui.navbar("navarea", '<span class="brand">'+
								   '<img align="middle" class="logo-img" src="img/chunt-logo.png"></img>'+
								   '<span class="brandtext">ChampHunt</span>'+
								   '<img align="middle" class="logo-live" src="img/radiotower.gif"></img>'+
								   '</span>' +
